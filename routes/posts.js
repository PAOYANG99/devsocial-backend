...
router.post('/', auth, async (req, res) => {
    ...
    try {
        ...
        const populatedPost = await Post.findById(savedPost.id).populate('author', ['username','profilePicture']);
...
router.post('/:id/comment', auth, async (req, res) => {
    ...
    try {
        ...
        await post.save();
        const populatedPost = await Post.findById(post.id).populate('comments.author', ['username']);
